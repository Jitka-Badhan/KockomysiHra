              ...
              <table>
                <tbody>
                  <tr className="score__quizzes">
                    <td className="scores__cell">Vyřešené rébusy:</td>
                    <td className="scores__cell">{myScores.riddles}</td>
                  </tr>
                  <tr className="score__time">
                    <td className="scores__cell">Čas:</td>
                    <td className="scores__cell">
                  ...
                  <tr className="score__R">
                    <td className="scores__cell">Číslo R:</td>
                    <td className="scores__cell">{myScores.score}</td>
                  </tr>
                </tbody>
              </table>
            </div>
